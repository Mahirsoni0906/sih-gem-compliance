...
export const CORE_SERVICE_DOMAINS = [
  { name: 'All Services', icon: 'all', count: 30 },
  { name: 'Manpower & Security', icon: 'security', count: 5 },
  { name: 'Transport & Fleet', icon: 'transport', count: 6 },
  { name: 'Catering & Hospitality', icon: 'catering', count: 4 },
  { name: 'IT & Hardware AMC', icon: 'it-hardware', count: 2 },
  { name: 'Printing & Media', icon: 'printing', count: 4 },
  { name: 'Facility Management', icon: 'sanitation', count: 2 },
  { name: 'Specialized & High-Tech', icon: 'drone', count: 4 },
  { name: 'Maintenance & Engineering', icon: 'industrial', count: 3 }
];
